...
const rabbitKickResponse = require('./fixtures/rabbitkick.js')
const payIdMayurResponse = require('./fixtures/payid-mayur.js')
...
describe("Verifies domains", () => {
    it("rabbitkick.club", async () => {
        ...
        expect(await verifyValidatorDomain(rabbitKickRpcResponse)).to.eql({
            status: 'success', 
            message: 'rabbitkick.club has been verified',
            manifest: rabbitKickRpcResponse
        })   
})
